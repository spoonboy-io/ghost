		...
		// create work order - good
		{
			...
			Request: mocks.Request{
				...
				Body: mocks.Properties{
					...
					//"values": "{\"TitleInstanceID\": \"SRGAA5V0HJTG5ASETL7ISDTFIZ52WS\", \"Login ID\": \"009695\",\"OfferingTitle\": \"Test Work Order\",\"Details\": \"Detailed information\",\"Source Keyword\": \"MyService\",\"SR Type Field 11\": \"Main Systems\",\"SR Type Field 12\": \"ITSM\",\"SR Type Field 13\": \"Remedy\",\"z1D Action\": \"CREATE\"}",
				},
			},
			Response: mocks.Response{
...
/*
{
						"TitleInstanceID": "SRGAA5V0HJTG5ASETL7ISDTFIZ52WS",
						"Login ID": "009695",
						"OfferingTitle": "Test Work Order",
						"Details": "Detailed information",
						"Source Keyword": "MyService",
						"SR Type Field 11": "Main Systems",
						"SR Type Field 12": "ITSM",
						"SR Type Field 13": "Remedy",
						"z1D Action": "CREATE",
					},
*/
